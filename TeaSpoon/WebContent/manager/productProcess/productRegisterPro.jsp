...
<%
	...
	product.setProduct_image1(fileName[3]);
	product.setProduct_image2(fileName[2]);
	product.setProduct_image3(fileName[1]);
	product.setProduct_image4(fileName[0]);
	product.setReg_date(new Timestamp(System.currentTimeMillis()));
	
	ProductDBBean productPro = ProductDBBean.getInstance();
	productPro.insertProduct(product);
